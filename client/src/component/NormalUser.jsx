...
export const NormalUser = () => {
    ...
    return (
        <div className="normaluser">
            ...
            <button style={{fontSize:"30px"}} onClick={() => navigate("/riotemployee/aggwithhaving",{state:{action: "Aggregation with having"}})}>Show the lowest-level of pro-players for each team....</button>
